...
//	}
    ...
    @Bean
    public DirectExchange miaoshaDirectExchange() {
        return new DirectExchange(MIAOSHA_QUEUE);
    }

    @Bean
    public Binding directBindingMiaosha() {
        return BindingBuilder.bind(miaoShaQueue()).to(miaoshaDirectExchange()).withQueueName();
    }
